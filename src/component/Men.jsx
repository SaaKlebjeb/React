        ...
        <div className='w-[90%] scrollbar-y  mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4  gap-6 mt-[70px] p-32 sm:p-0 '>
            {
              Onlymen.map((item,index)=>(
                <div key={index} data-aos="zoom-out-down"  data-aos-duration="1200" className="relative w-full   group card shadow-lg rounded-md  overflow-hidden ">
                ...
                <img                                                                               
                    className="w-full object-contain sm:h-auto h-[600px]"
                    src={item.image}
                    alt={item.title}
                  />
